...
use crate::model::TerminologyCapabilities_Version::TerminologyCapabilities_VersionGraphql;
use async_graphql::*;
use serde_json::json;
...
pub struct TerminologyCapabilities_CodeSystemGraphql {
    _subsumption: Option<ElementGraphql>,
    extension: Option<Vec<ExtensionGraphql>>,
    id: Option<String>,
    modifier_extension: Option<Vec<ExtensionGraphql>>,
    subsumption: Option<bool>,
    uri: Option<String>,
    version: Option<Vec<TerminologyCapabilities_VersionGraphql>>,
}
