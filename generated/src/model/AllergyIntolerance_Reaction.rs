...
pub struct AllergyIntolerance_ReactionGraphql {
    _description: Option<ElementGraphql>,
    _onset: Option<ElementGraphql>,
    _severity: Option<ElementGraphql>,
    description: Option<String>,
    exposure_route: Option<CodeableConceptGraphql>,
    extension: Option<Vec<ExtensionGraphql>>,
    id: Option<String>,
    manifestation: Vec<CodeableConceptGraphql>,
