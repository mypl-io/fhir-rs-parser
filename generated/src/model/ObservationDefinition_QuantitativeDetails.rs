...
pub struct ObservationDefinition_QuantitativeDetailsGraphql {
    _conversion_factor: Option<ElementGraphql>,
    _decimal_precision: Option<ElementGraphql>,
    conversion_factor: Option<f64>,
    customary_unit: Option<CodeableConceptGraphql>,
    decimal_precision: Option<i64>,
