...
#[derive(Debug)]
pub struct MedicationKnowledge_MonitoringProgram<'a> {
...
impl MedicationKnowledge_MonitoringProgramBuilder {
    pub fn build(&self) -> MedicationKnowledge_MonitoringProgram {
        MedicationKnowledge_MonitoringProgram {
...
pub struct MedicationKnowledge_MonitoringProgramGraphql {
