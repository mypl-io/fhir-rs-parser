...
use crate::model::VisionPrescription_LensSpecification::VisionPrescription_LensSpecificationGraphql;
use async_graphql::*;
use serde_json::json;
...
pub struct VisionPrescriptionGraphql {
    _created: Option<ElementGraphql>,
    _date_written: Option<ElementGraphql>,
    ...
    lens_specification: Vec<VisionPrescription_LensSpecificationGraphql>,
    meta: Option<MetaGraphql>,
    modifier_extension: Option<Vec<ExtensionGraphql>>,
    patient: ReferenceGraphql,
    prescriber: ReferenceGraphql,
