...
#[derive(Debug)]
pub struct SpecimenDefinition_Additive<'a> {
...
impl SpecimenDefinition_AdditiveBuilder {
    pub fn build(&self) -> SpecimenDefinition_Additive {
        SpecimenDefinition_Additive {
...
pub struct SpecimenDefinition_AdditiveGraphql {
    additive_codeable_concept: Option<CodeableConceptGraphql>,
    additive_reference: Option<ReferenceGraphql>,
