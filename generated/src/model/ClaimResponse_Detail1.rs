...
use crate::model::ClaimResponse_SubDetail1::ClaimResponse_SubDetail1Graphql;
...
pub struct ClaimResponse_Detail1Graphql {
    ...
    sub_detail: Option<Vec<ClaimResponse_SubDetail1Graphql>>,
