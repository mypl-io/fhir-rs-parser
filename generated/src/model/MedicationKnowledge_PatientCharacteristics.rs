...
pub struct MedicationKnowledge_PatientCharacteristicsGraphql {
    _value: Option<Vec<ElementGraphql>>,
    characteristic_codeable_concept: Option<CodeableConceptGraphql>,
    characteristic_quantity: Option<QuantityGraphql>,
