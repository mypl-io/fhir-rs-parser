...
use crate::model::Measure_Component::Measure_ComponentGraphql;
use async_graphql::*;
use serde_json::json;
...
pub struct Measure_StratifierGraphql {
    _description: Option<ElementGraphql>,
    code: Option<CodeableConceptGraphql>,
    component: Option<Vec<Measure_ComponentGraphql>>,
    criteria: Option<ExpressionGraphql>,
