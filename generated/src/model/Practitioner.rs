...
use crate::model::Practitioner_Qualification::Practitioner_QualificationGraphql;
...
pub struct PractitionerGraphql {
    ...
    qualification: Option<Vec<Practitioner_QualificationGraphql>>,
