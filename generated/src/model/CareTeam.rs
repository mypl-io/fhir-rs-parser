...
use crate::model::CareTeam_Participant::CareTeam_ParticipantGraphql;
...
pub struct CareTeamGraphql {
    ...
    managing_organization: Option<Vec<ReferenceGraphql>>,
    meta: Option<MetaGraphql>,
    modifier_extension: Option<Vec<ExtensionGraphql>>,
    name: Option<String>,
    note: Option<Vec<AnnotationGraphql>>,
    participant: Option<Vec<CareTeam_ParticipantGraphql>>,
