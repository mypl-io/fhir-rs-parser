...
pub struct SpecimenDefinition_HandlingGraphql {
    _instruction: Option<ElementGraphql>,
    extension: Option<Vec<ExtensionGraphql>>,
    id: Option<String>,
    instruction: Option<String>,
    max_duration: Option<DurationGraphql>,
    modifier_extension: Option<Vec<ExtensionGraphql>>,
    temperature_qualifier: Option<CodeableConceptGraphql>,
    temperature_range: Option<RangeGraphql>,
}
