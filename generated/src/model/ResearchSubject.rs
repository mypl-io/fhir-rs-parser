...
pub struct ResearchSubjectGraphql {
    _actual_arm: Option<ElementGraphql>,
    _assigned_arm: Option<ElementGraphql>,
    _implicit_rules: Option<ElementGraphql>,
    _language: Option<ElementGraphql>,
    _status: Option<ElementGraphql>,
    actual_arm: Option<String>,
    assigned_arm: Option<String>,
    consent: Option<ReferenceGraphql>,
    contained: Option<Vec<ResourceListGraphql>>,
    extension: Option<Vec<ExtensionGraphql>>,
    id: Option<String>,
    identifier: Option<Vec<IdentifierGraphql>>,
    implicit_rules: Option<String>,
    individual: ReferenceGraphql,
