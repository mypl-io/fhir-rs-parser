...
pub struct Contract_SecurityLabelGraphql {
    _number: Option<Vec<ElementGraphql>>,
    category: Option<Vec<CodingGraphql>>,
    classification: CodingGraphql,
    control: Option<Vec<CodingGraphql>>,
    extension: Option<Vec<ExtensionGraphql>>,
    id: Option<String>,
    modifier_extension: Option<Vec<ExtensionGraphql>>,
    number: Option<Vec<u64>>,
}
