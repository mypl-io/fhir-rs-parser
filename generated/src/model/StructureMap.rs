...
use crate::model::StructureMap_Group::StructureMap_GroupGraphql;
use crate::model::StructureMap_Structure::StructureMap_Structure;
use crate::model::StructureMap_Structure::StructureMap_StructureGraphql;
...
pub struct StructureMapGraphql {
    ...
    group: Vec<StructureMap_GroupGraphql>,
    id: Option<String>,
