...
pub struct BodyStructureGraphql {
    ...
    location: Option<CodeableConceptGraphql>,
    location_qualifier: Option<Vec<CodeableConceptGraphql>>,
    meta: Option<MetaGraphql>,
    modifier_extension: Option<Vec<ExtensionGraphql>>,
    morphology: Option<CodeableConceptGraphql>,
