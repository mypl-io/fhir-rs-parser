...
use crate::model::EvidenceVariable_Characteristic::EvidenceVariable_CharacteristicGraphql;
...
pub struct EvidenceVariableGraphql {
    ...
    characteristic: Vec<EvidenceVariable_CharacteristicGraphql>,
