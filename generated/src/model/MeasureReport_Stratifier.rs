...
use crate::model::MeasureReport_Stratum::MeasureReport_StratumGraphql;
use async_graphql::*;
use serde_json::json;
...
pub struct MeasureReport_StratifierGraphql {
    code: Option<Vec<CodeableConceptGraphql>>,
    extension: Option<Vec<ExtensionGraphql>>,
    id: Option<String>,
    modifier_extension: Option<Vec<ExtensionGraphql>>,
    stratum: Option<Vec<MeasureReport_StratumGraphql>>,
}
