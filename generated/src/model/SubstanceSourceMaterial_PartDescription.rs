...
impl SubstanceSourceMaterial_PartDescriptionBuilder {
    pub fn build(&self) -> SubstanceSourceMaterial_PartDescription {
        SubstanceSourceMaterial_PartDescription {
...
pub struct SubstanceSourceMaterial_PartDescriptionGraphql {
    extension: Option<Vec<ExtensionGraphql>>,
    id: Option<String>,
    modifier_extension: Option<Vec<ExtensionGraphql>>,
    part: Option<CodeableConceptGraphql>,
    part_location: Option<CodeableConceptGraphql>,
}
