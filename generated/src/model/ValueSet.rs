...
use crate::model::ValueSet_Compose::ValueSet_ComposeGraphql;
use crate::model::ValueSet_Expansion::ValueSet_Expansion;
use crate::model::ValueSet_Expansion::ValueSet_ExpansionGraphql;
use async_graphql::*;
use serde_json::json;
...
pub struct ValueSetGraphql {
    ...
    _immutable: Option<ElementGraphql>,
    ...
    compose: Option<ValueSet_ComposeGraphql>,
    contact: Option<Vec<ContactDetailGraphql>>,
    contained: Option<Vec<ResourceListGraphql>>,
    copyright: Option<String>,
    date: Option<String>,
    description: Option<String>,
    expansion: Option<ValueSet_ExpansionGraphql>,
