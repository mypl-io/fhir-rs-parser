...
pub struct InsurancePlan_CostGraphql {
    applicability: Option<CodeableConceptGraphql>,
    extension: Option<Vec<ExtensionGraphql>>,
    id: Option<String>,
    modifier_extension: Option<Vec<ExtensionGraphql>>,
    qualifiers: Option<Vec<CodeableConceptGraphql>>,
    fhir_type: CodeableConceptGraphql,
    value: Option<QuantityGraphql>,
}
