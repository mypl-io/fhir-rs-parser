...
use crate::model::ResearchElementDefinition_Characteristic::ResearchElementDefinition_CharacteristicGraphql;
...
pub struct ResearchElementDefinitionGraphql {
    _approval_date: Option<ElementGraphql>,
    _comment: Option<Vec<ElementGraphql>>,
    ...
    _short_title: Option<ElementGraphql>,
    ...
    _variable_type: Option<ElementGraphql>,
    _version: Option<ElementGraphql>,
    approval_date: Option<String>,
    author: Option<Vec<ContactDetailGraphql>>,
    characteristic: Vec<ResearchElementDefinition_CharacteristicGraphql>,
